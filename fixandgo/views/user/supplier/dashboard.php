...
<body>
  ...
  function loadStats() {
    // Product count
    fetch('../../../backend/supplier_products.php?action=list', { credentials: 'include' })
      .then(r => r.json())
      .then(d => {
        if (!d.success) return;
    ...
    fetch('../../../backend/supplier_orders.php?action=stats', { credentials: 'include' })
      .then(r => r.json())
      .then(d => {
        if (!d.success) return;
    ...
    fetch('../../../backend/supplier_sales.php?action=stats', { credentials: 'include' })
      .then(r => r.json())
      .then(d => {
  ...
  function loadRecentPurchases() {
    fetch('../../../backend/supplier_sales.php?action=purchases', { credentials: 'include' })
      .then(r => r.json())
      .then(d => {
