...
<body>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('avatarInput').addEventListener('change', function () {
      ...
      fetch('../../../backend/customer_profile.php', { method: 'POST', body: fd, credentials: 'include' })
        .then(r => r.json())
        .then(d => {
          if (d.success) {
    ...
    document.getElementById('profileForm').addEventListener('submit', function(e) {
      ...
      fetch('../../../backend/customer_profile.php', {
        method: 'POST',
  ...
  function loadProfile() {
    fetch('../../../backend/customer_profile.php?action=get', { credentials: 'include' })
      .then(r => r.json())
      .then(d => {
        if (!d.success) return;
        const u = d.user;
