...
<head>
  ...
  <title>Fix&Go — Manage Products</title>
...
<body>
  ...
  <div class="supplier-layout">
    ...
    <aside class="supplier-sidebar" id="supplierSidebar">
      ...
      <ul class="sidebar-nav">
        ...
        <li><a href="products.php" class="active"><i class="bi bi-box-seam"></i> Manage Products</a></li>
    ...
    <main class="supplier-main">
      ...
      <div class="page-header">
        <div>
          ...
          <p>Your shop's product inventory</p>
        </div>
      ...
      <div class="stats-grid">
        ...
        <div class="stat-card">
          <div class="stat-icon" style="background:rgba(230,168,0,0.12);color:#e6a800;"><i class="bi bi-currency-dollar"></i></div>
          <div>
            <div class="stat-value" style="color:#e6a800;" id="statValue">₱0</div>
            <div class="stat-label">Total Value</div>
          </div>
        </div>
        <div class="stat-card">
          <div class="stat-icon" style="background:rgba(108,117,125,0.12);color:#6C757D;"><i class="bi bi-file-earmark"></i></div>
          <div>
            <div class="stat-value" style="color:#6C757D;" id="statDraft">0</div>
      ...
      <div class="toolbar">
        <div class="toolbar-left">
          <button class="btn-toolbar success" id="btnSendToSupervisor" style="display:none;">
            <i class="bi bi-send"></i> Send to Supervisor
          </button>
          <button class="btn-toolbar danger" id="btnDeleteSelected" style="display:none;">
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <input type="text" class="form-input" id="category"
                     placeholder="e.g. Tempered Glass, Cable" required>
            </div>
            <div class="form-group">
              <label>Brand</label>
  ...
  <script src="manage-products.js?v=7"></script>
  <script>
