...
<head>
  ...
  <style>
    ...
    .supplier-main{flex:1;padding:1.5rem;min-width:0;display:flex;flex-direction:column;}
  ...
  <div class="supplier-layout">
    <aside class="supplier-sidebar" id="supplierSidebar">
      ...
      <ul class="sidebar-nav">
        ...
        <li><a href="staff.php"><i class="bi bi-people-fill"></i> Staff</a></li>
