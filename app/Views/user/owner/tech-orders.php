...
<head>
  ...
  <style>
    ...
    .supplier-sidebar{width:240px;flex-shrink:0;background:var(--fg-card-bg);border-right:1px solid var(--fg-border);padding:1.5rem 0;position:sticky;top:68px;height:calc(100vh - 68px);overflow-y:auto;}
...
<body>
  ...
  <div id="statusModal" style="display:none;position:fixed;inset:0;z-index:9000;background:rgba(0,0,0,0.5);align-items:center;justify-content:center;padding:1rem;">
    <div style="background:var(--fg-card-bg);border:1px solid var(--fg-border);border-radius:16px;width:100%;max-width:420px;padding:1.75rem;">
      ...
      <div style="display:flex;gap:0.75rem;justify-content:flex-end;">
        ...
        <button id="modalConfirmBtn" onclick="confirmStatusUpdate()" style="padding:0.5rem 1.25rem;border-radius:8px;border:none;font-size:0.85rem;font-weight:700;cursor:pointer;color:#000;background:var(--fg-primary);">Update</button>
      </div>
    </div>
  </div>
  ...
  <script>
  'use strict';
  const API = '/api/seller/tech-orders';
