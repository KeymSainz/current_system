  ...
  <div class="supplier-layout">
    ...
    <main class="supplier-main">
      ...
      <div class="mb-4">
        ...
        <p style="color:var(--fg-muted);margin:0;font-size:0.9rem;">Track and manage your outgoing deliveries</p>
      </div>
      ...
      <div class="row g-3 mb-4">
        <div class="col-6 col-lg-3">
          <div class="stat-card">
            ...
            <div>
              <div class="stat-value" style="color:#2563eb;">4</div>
        ...
        <div class="col-6 col-lg-3">
          <div class="stat-card">
            ...
            <div>
              <div class="stat-value" style="color:#059669;">3</div>
        ...
        <div class="col-6 col-lg-3">
          <div class="stat-card">
            <div class="stat-icon" style="background:rgba(230,168,0,0.12);color:#c98f00;">
              <i class="bi bi-box-seam"></i>
            </div>
            <div>
              <div class="stat-value" style="color:#c98f00;">2</div>
