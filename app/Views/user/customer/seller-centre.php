...
<body>
  ...
  function submitApplication() {
    ...
    fetch('/api/seller/apply', {method:'POST', body:fd, credentials:'include'})
  ...
  function customerLogout() {
    FGAuth.showLogoutModal(function() {
      ...
      fetch('/api/logout').finally(function(){ window.location.href = '/login.html'; });
    });
  }
  ...
  function switchToSeller(role, customerId) {
    ...
    fetch('/api/seller/switch', {method:'POST',credentials:'include',headers:{'Content-Type':'application/json'},body:JSON.stringify({customer_id:customerId,role:role})})
      .then(function(r){return r.json();})
      .then(function(d) {
  ...
  function renderPendingUI(app, user) {
    ...
    fetch('/api/document-approvals?action=my_documents&customer_id=' + (user.id||''), {credentials:'include'})
      .then(function(r){return r.json();})
      .then(function(data) {
  ...
  function submitResubmission() {
    ...
    fetch('/api/document-approvals', {method:'POST',body:fd,credentials:'include'})
      .then(function(r){return r.json();})
      .then(function(d) {
